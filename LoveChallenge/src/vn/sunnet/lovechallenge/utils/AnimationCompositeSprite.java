...
/**
 * <p>
 * An Animation stores a list of {@link Sprite}s representing an animated
 ...
 * @author mzechner
 */
public class AnimationCompositeSprite {
	...
	final CompositeSprite[] keyFrames;
	 ...
	 * @param keyFrames
	 *            the {@link Sprite}s representing the frames.
	 */
	public AnimationCompositeSprite(float frameDuration,
			Array<? extends CompositeSprite> keyFrames) {
		this.frameDuration = frameDuration;
		this.animationDuration = keyFrames.size * frameDuration;
		this.keyFrames = new CompositeSprite[keyFrames.size];
	 ...
	 */
	public AnimationCompositeSprite(float frameDuration,
			Array<? extends CompositeSprite> keyFrames, int playType) {
	 ...
	 *            the {@link Sprite}s representing the frames.
	 */
	public AnimationCompositeSprite(float frameDuration, CompositeSprite... keyFrames) {
		this.frameDuration = frameDuration;
	 ...
	 *         state time.
	 */
	public CompositeSprite getKeyFrame(float stateTime, boolean looping) {
		...
		CompositeSprite frame = getKeyFrame(stateTime);
	 ...
	 *         state time.
	 */
	public CompositeSprite getKeyFrame(float stateTime) {
	...
	/**
	 * Returns the animation play mode. Will be one of the following:
	 * Animation.NORMAL, Animation.REVERSED, Animation.LOOP,
	...
	public void setPosition(float x, float y) {
		for (CompositeSprite keyFrame : keyFrames) {
